...
pub fn linfa_pred() {
    ...
    let test_rows: Vec<FakeRow> = vec![FakeRow{a: 1., b: 6., c: 3.,d:12.,e:13.,f:30.,g:33.,h:1.,j:1.,k:1.}, FakeRow{a: 1., b: 1.,c:1.,d:1.,e:9.,f:134.,g:312.,h:2.,j:1.,k:5.}, FakeRow{a: 1., b: 1.,c:1.,d:1.,e:9.,f:34.,g:32.,h:2.,j:1.,k:5.}];

    let built_arr: Array2<f32> = test_rows.iter()
        .map(|row| [row.a, row.b, row.c, row.d, row.e, row.f, row.g, row.h, row.j, row.k])
        .collect::<Vec<_>>()
        .into();
    ...
    let original_data: Array2<f32> = array!(
        [1.,    6.,    3.,     12.,    13.,     30.,      33.,      1.,     1.,    1.],
        [1.,    3.,    1.,     3.,     8.,      122.,     44.,      2.,     1.,    2.],
        [1.,    1.,    1.,     1.,     9.,      34.,      32.,      2.,     1.,    5.],
        [1.,    5.,    3.,     6.,     9.,      13.,      123.,     1.,     0.,    1.],
        [1.,    2.,    2.,     6.,     10.,     35.,      744.,     0.,     1.,    7.],
        [1.,    8.,    1.,     6.,     16.,     66.,      0.,       2.,     1.,    2.],
        [1.,    7.,    2.,     12.,    13.,     43.,      32.,      1.,     1.,    4.],
        [1.,    4.,    1.,     3.,     11.,     15.,      0.,       3.,     0.,    6.],
        [1.,    3.,    1.,     1.,     7.,      77.,      44.,      4.,     1.,    5.],
        [1.,    5.,    3.,     4.,     8.,      111.,     122.,     0.,     0.,    7.],
        [1.,    12.,   5.,     4.,     16.,     31.,      522.,     1.,     0.,    4.],
        [1.,    13.,   4.,     3.,     15.,     52.,      0.,       0.,     1.,    3.]
    );

    dbg!(&original_data);

    let feature_names = vec!["consult_purpose_id", "client_id", "client_type", "location_id", "hour_of_day", "length_of_meeting", "notes_length", "num_attachments", "received_follow_up", "consultant_id"];
